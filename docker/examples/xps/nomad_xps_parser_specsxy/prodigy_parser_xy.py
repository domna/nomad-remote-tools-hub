...
from nomad_xps_parser_specsxy.measurement_data_class import (
...
if __name__ == "__main__": 
    ...
    f = r'C:\Users\Mark\Downloads\converters\XPS Data example.xy'
...
if __name__ == "__main__": 
    ...
    parser = ProdigyParserXY(author='Mark Greiner')
    parser.parseFile(f)
    ''' The next two methods are some cleaning steps that we typically do.'''
    parser.removeAlign()
    parser.extractAllTags()
    
    ''' The dataset is a list of dictionaries, where each spectrum is one item
    in the list. '''
